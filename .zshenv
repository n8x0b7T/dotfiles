...
# Alias!
alias sudo='doas'
alias ls="eza --color-scale all --group-directories-first --time-style relative -F --git"
...
alias upgrade='paru -Syu --sudo-loop'
...
alias gradler="gradle build && java -cp app/build/classes/java/main"
